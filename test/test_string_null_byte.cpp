...
struct StrField { string s; };
struct TwoStrFields { string a; string b; };
struct WithVecStr { vector<string> items; };
...
TEST_CASE("BUG: second string field after null-embedded first is also correct") {
